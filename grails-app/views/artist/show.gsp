	...
	<body>
		...
		<div id="show-artist" class="content scaffold-show" role="main">
			...
			<ol class="property-list artist">
				...
				<g:if test="${artistInstance?.age}">
				<li class="fieldcontain">
					<span id="age-label" class="property-label"><g:message code="artist.age.label" default="Age" /></span>
					
						<span class="property-value" aria-labelledby="age-label"><g:fieldValue bean="${artistInstance}" field="age"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${artistInstance?.email}">
				<li class="fieldcontain">
					<span id="email-label" class="property-label"><g:message code="artist.email.label" default="Email" /></span>
					
						<span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${artistInstance}" field="email"/></span>
